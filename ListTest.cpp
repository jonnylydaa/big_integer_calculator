...
// * ListTest.cpp
// * Testing script for List ADT and all of its functions
// *********************************************************************************/
// #include<iostream>
// #include<string>
// #include<stdexcept>
...
//    // List A, B;
//    List X, Y, Z;
//    cout << "X before 1 insert after: " << X << endl;
//    cout << "X length before 1 insert after: " << X.length() << endl;
//    X.insertAfter(1);
//    cout << "X after 1 insert after: " << X << endl;
//    cout << "X length after 1 insert after: " << X.length() << endl;
//    X.insertAfter(2);
//    X.insertAfter(3);
//    Y.insertAfter(4);
//    Y.insertAfter(5);
...
//    H.insertBefore(4);
//    H.setBefore(1);
//    cout << "H in cleanup position" << H << endl;
//    cout << "before H cursor position" << H.position() << endl;
//    H.findPrev(3);
//    cout << "A cursor position" << H.position() << endl;
//    H.cleanup();
//    cout << "H after cleanup" << H << endl;
//    cout << "H cursor position after clean up" << H.position() << endl;
//    if (H.position() != 2)
//    cout << "position issue with H" << endl;
...
//    J.cleanup();
//    if (J.position() != 2)
//    cout << "position issue with J" << endl;
